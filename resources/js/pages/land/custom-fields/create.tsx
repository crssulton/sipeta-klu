...
export default function CustomFieldCreate() {
    ...
    const [isVisibleInDetail, setIsVisibleInDetail] = useState(true);
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Tambah Field', href: '/custom-fields/create' },
            ]}
        >
            <div className="mx-auto w-full max-w-2xl space-y-6 p-6">
                <div>
                    <h1 className="text-3xl font-bold">Tambah Custom Field</h1>
                    <p className="mt-2 text-muted-foreground">
                        Buat field dinamis baru untuk form tanah
                    </p>
                </div>
                        ...
                        <>
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="field_label"
                                    name="field_label"
                                    placeholder="Contoh: Sumber Data"
                                    required
                                    onChange={(e) => {
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    placeholder="contoh: sumber_data"
                                    pattern="[a-z_]+"
                                    required
                                />
